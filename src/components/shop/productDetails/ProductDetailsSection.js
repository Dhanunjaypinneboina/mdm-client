...
const ProductDetailsSection = (props) => {
  ...
  return (
    <Fragment>
      ...
      />
      <section className="m-2 md:mx-12 md:my-6">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex justify-between items-center mb-4 ">
                <svg
                  ...
                  className="flex justify-center  w-12 h-12 text-gray-1000 opacity-25 cursor-pointer hover:text-yellow-1000 hover:opacity-150"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
