            ...
            <div className="flex flex-col mt-4">
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  ...
                  <img
                    className="h-16 w-16 object-cover"
                    src={`${apiURL}/uploads/products/${editformData.pImages[2]}`}
                    alt="productImage"
                  />
                  <img
                    className="h-16 w-16 object-cover"
                    src={`${apiURL}/uploads/products/${editformData.pImages[3]}`}
                    alt="productImage"
                  />
                </div>
              ) : (
              ...
              <span className="text-gray-600 text-xs">Must need 4 images</span>
              <input
                onChange={(e) =>
                  setEditformdata({
                    ...editformData,
